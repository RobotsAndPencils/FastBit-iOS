...
lipo -remove x86_64 -output "${SIMULATOR_OUTPUT}/skinny-${LIBRARY_NAME}" "${SIMULATOR_OUTPUT}/${LIBRARY_NAME}"
lipo -create -output "${UNIVERSAL_OUTPUT}/${LIBRARY_NAME}" "${DEVICE_OUTPUT}/${LIBRARY_NAME}" "${SIMULATOR_OUTPUT}/skinny-${LIBRARY_NAME}"
